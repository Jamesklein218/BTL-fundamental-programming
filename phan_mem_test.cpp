...
int main()
{
    ...
    if (inputFile.is_open() && outputFile.is_open())
    {
        while (count <= MAX_COUNT)
        {
            ...
            task2_EXP1 = std::stoi(trich_xuat);
            task2_EXP2 = std::stoi(trich_xuat1);
            task2_HP2 = std::stoi(trich_xuat2);
            // So sanh
            ...
            task3_HP1 = std::stoi(trich_xuat);
            task3_EXP1 = std::stoi(trich_xuat1);
            // Compare
